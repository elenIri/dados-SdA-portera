...
(function(dice) {
    ...
    this.standart_d20_dice_face_labels1 = [' ', '0', '1', '0', '0', '0', '0', '0'];
    this.standart_d20_dice_face_labels2 = [' ', '0', '1', '1', '0', '0', '0', '0'];
    this.standart_d20_dice_face_labels3 = [' ', '0', '1', '1', '1', '0', '0', '0'];
    this.standart_d20_dice_face_labels4 = [' ', '0', '1', '1', '1', '1', '0', '0']; 
    this.standart_d20_dice_face_labels5 = [' ', '0', '1', '1', '1', '1', '1', '0']; 
    ...
    this.ambient_light_color = '#f0edf3';  /*0xf0f5fb*/
    ...
    this.known_types = ['d1', 'd2', 'd3', 'd4', 'd5'];
    /*this.dice_face_range = { 'd1': [1, 4], 'd2': [1, 6], 'd3': [1, 8], 'd4': [0, 9], 'd5': [0, 9],
        'd12': [1, 12], 'd20': [1, 20], 'd40': [0, 9] };*/
    this.dice_mass = { 'd1': 300, 'd2': 300, 'd3': 300, 'd4': 300, 'd5': 300, 'd12': 350, 'd20': 400, 'd40': 350 };
    this.dice_inertia = { 'd1': 5, 'd2': 13, 'd3': 10, 'd4': 9, 'd5': 9, 'd12': 8, 'd20': 6, 'd40': 9 };
    ...
    this.create_d5 = function() {
        if (!this.d2_geometry) this.d2_geometry = this.create_d2_geometry(this.scale * 0.9);
        /*if (!this.dice_material)*/ this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials(this.standart_d20_dice_face_labels5, this.scale / 2, 1.0, col5));
        return new THREE.Mesh(this.d2_geometry, this.dice_material);
    }
...
*/
    ...
    this.dice_box.prototype.draw_selector = function() {
        ...
        for (var i = 0, pos = -4; i < that.known_types.length; ++i, pos+=2) {
